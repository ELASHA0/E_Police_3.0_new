...
import 'CreateAndEditTask/AddTaskScreen.dart';
import 'CreateAndEditTask/EditTaskScreen.dart';
import 'ShowCompletedTask/CompletedTaskScreen.dart';
import 'TaskAction/TaskActionScreen.dart';
...
class _TaskcardState extends State<Taskcard> {
  ...
  final adminDashboardController dashboardController = Get.find<adminDashboardController>();
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        formatDate(widget.task.deadline ?? DateTime.now()),
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
                    ],
                  ),
              ...
              children: [
                Padding(
                  ...
                  child: OutlinedButton(
                      ...
                      onPressed: () {
                        Get.to(EditTaskScreen(editTask: widget.task,));
                      },
                      child: const Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(right: 15, left: 15, bottom: 4),
                  child: OutlinedButton(
                      style: ElevatedButton.styleFrom(
                        side: BorderSide(
                ...
                dashboardController.permissions.value != null ? moreButton()
                    : SizedBox(height: 0.1),
                deleteTaskButton()
              ],
            )
  ...
  Widget moreButton() {
    return Padding(
      padding: const EdgeInsets.only(right: 15, left: 15, bottom: 4),
      child: OutlinedButton(
          style: ElevatedButton.styleFrom(
          ...
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(
              ...
              CompletedTaskScreen(task: widget.task)
                  : TaskActionScreen(taskId: widget.task.id ?? "",),
            ),);
          },
          child: const Row(
            mainAxisAlignment: MainAxisAlignment.center,
  ...
  Future<void> deleteTask(BuildContext context) async {
    showLoading();
    try {
      final uri = Uri.parse('${dotenv.env['BASE_URL']}/api/api/task/${widget.task.id}');
