...
class Filtrationsystemlead extends StatefulWidget {
  const Filtrationsystemlead({super.key});

  @override
  State<Filtrationsystemlead> createState() => _FiltrationsystemleadState();
}

class _FiltrationsystemleadState extends State<Filtrationsystemlead> {
  DateTime? fromDate;
  DateTime? tillDate;
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: Text(
                      fromDate != null
                          ...
                          : DateFormat('dd/MM/yyyy').format(thisMonth),
                  ...
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        ...
                        controller.selectedTag.value = "Deal";
                      });
                    ...
                    child: Padding(
                      ...
                      child: Container(
                          decoration: BoxDecoration(
                            color: controller.selectedTag.value == "Deal"
                                ? MyColor.dashbord
                                : Colors.green,
                            borderRadius: BorderRadius.circular(
                                10), // optional: rounded corners
