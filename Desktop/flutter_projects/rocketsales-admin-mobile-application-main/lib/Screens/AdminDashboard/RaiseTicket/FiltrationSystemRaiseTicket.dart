...
class FiltrationsystemTickets extends StatefulWidget {
  const FiltrationsystemTickets({super.key});

  @override
  State<FiltrationsystemTickets> createState() =>
      _FiltrationsystemTicketsState();
}

class _FiltrationsystemTicketsState extends State<FiltrationsystemTickets> {
  DateTime? fromDate;
  DateTime? tillDate;
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        setState(() {
                          print("open clicked");
                          controller.selectedTag.value = "open";
                        });
                        controller.getTickets();
                      },
                      child: Padding(
                        ...
                        child: Container(
                          alignment: Alignment.center,
                            decoration: BoxDecoration(
                              color: controller.selectedTag.value == "open"
                                  ? MyColor.dashbord
                                  : Colors.grey,
                              borderRadius: BorderRadius.circular(
                                  10), // optional: rounded corners
                  ...
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        ...
                        controller.selectedTag.value = "in-progress";
                      });
                      controller.getTickets();
                    },
                    child: Padding(
                      ...
                      child: Container(
                          decoration: BoxDecoration(
                            color: controller.selectedTag.value == "in-progress"
                                ? MyColor.dashbord
                                : Colors.yellow,
                            borderRadius: BorderRadius.circular(
                                10), // optional: rounded corners
                  ...
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        print("resolved clicked");
                        controller.selectedTag.value = "resolved";
                      });
                    ...
                    child: Padding(
                      ...
                      child: Container(
                          decoration: BoxDecoration(
                            color: controller.selectedTag.value == "resolved"
                                ? MyColor.dashbord
                                : Colors.green,
                            borderRadius: BorderRadius.circular(
                                10), // optional: rounded corners
