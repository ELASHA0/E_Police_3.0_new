...
class CreateEditExpenseController extends GetxController {
  ...
  Future<void> uploadExpense(BuildContext context) async {
    showLoading(context);
    try {
      print("===========>>>>>>>>> ${controller.salesmanId.value}");
      ...
      request.fields['salesmanId'] = controller.salesmanId.value;
      ...
      if (response.statusCode == 201) {
        ...
        print("❌ Expense submission Failed: ${response.body}");
        Get.snackbar("Error", response.body);
      }
    } catch (e) {
      Navigator.of(context).pop();
      print("⚠️ Exception in posting Expense: $e");
